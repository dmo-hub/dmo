...
MANUAL = {
    ...
    "คอร์ดรามอน(กรีน)": "Coredramon(Green)",
    "คาออสมอน": "Chaosmon",
    "คิวบีมอน": "Kyubimon",
    "คิเมรามอน": "Kimeramon",
    "คูลูมอน": "Culumon",
    "จินลองมอน": "Huanglongmon",
    "จูเรย์มอน": "Cherrymon",
    "ดราคุมอน": "Dracmon",
    "ดาร์คทีราโนมอน": "DarkTyrannomon",
    "ดุ๊คมอน คริมสันโหมด": "Gallantmon Crimson Mode",
    "ทอยอากูมอน": "ToyAgumon",
    "ปรินซ์มาเมมอน": "PrinceMamemon",
    "ปิเอมอน": "Piedmon",
    "พล็อตมอน": "Salamon",
    "พาราไซมอน": "Parasimon",
    "ฟานลองมอน": "Fanglongmon",
    "มัชชูมอน": "Mushroomon",
    "มุเกนดรามอน": "MugenDramon",
    "ยูคิดารุมอน": "Yukidarumon",
    "ลอร์ดไนท์มอน": "LordKnightmon",
    "ลูเจมอน ซาตานโหมด": "Lucemon Satan Mode",
    "วาจิรามอน": "Vajramon",
    "วาสพ์มอน": "Waspmon",
    "สกัลเกรย์มอน": "SkullGreymon",
    "อัลฟามอน": "Alphamon",
    "อิคคาคุมอน": "Ikkakumon",
    "เครามอน": "Keramon",
    "เคออส ปิเอมอน": "ChaosPiedmon",
    "เจสมอน": "Jesmon",
    "เชนทารูมอน": "Centarumon",
    "เชาท์มอนX2": "ShoutmonX2",
    "เซเวียร์แฮคมอน": "SaviorHackmon",
    "เดธ X โดรุเกรย์มอน": "Death-X-DoruGreymon",
    "เดธ X โดรุโกรามอน": "Death-X-Dorugoramon",
    "เนโอเดวีมอน": "NeoDevimon",
    "เมทัลการูรูมอน": "MetalGarurumon",
    "เมทัลซีดรามอน": "MetalSeadramon",
    "เมทัลทีราโมมอน": "MetalTyrannomon",
    "เรนามอน": "Renamon",
    "เรพิดมอน": "Rapidmon",
    "เอ็กซามอน": "Examon",
    "แกรนดิสคุวากามอน": "GrandisKuwagamon",
    "แบล็ควาร์การูรูมอน": "BlackWereGarurumon",
    "แรปเตอร์ดรามอน": "Raptordramon",
    "แร็ปเตอร์ดรามอน": "Raptordramon",
    "แรร์มอน": "Raremon",
    "แฮคมอน": "Hackmon",
    "โกเลมอน": "Golemon",
    "โบลท์โบทามอน": "BoltBotamon",
    "โบโคมอน": "Bokomon",
    "โมโนคุโรมอน": "Monochromon",
    "โมโนดรามอน": "Monodramon",
    "โรสมอน": "Rosemon",
    "โอเมกามอน สวอร์ธ": "Omegamon Zwart",
    "ไทแรนคาบุเทริมอน": "TyrantKabuterimon",
    "ไทแรนคาบูเทริมอน": "TyrantKabuterimon",
    "ไบฟูมอน": "Baihumon",
}
...
def main():
    ...
    T = {f"{k}#{ti}": rows(t["html"]) for k, v in d.items() for ti, t in enumerate(v["tables"])}
    ...
    print(
        f"Wrote {OUT.name}: {len(out)} names (bootstrap {len(boot)}, manual/override {len(MANUAL)})"
    )
